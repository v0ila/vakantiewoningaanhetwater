  ...
  <section class="hero feature one-feature is-large fadeIn">
    <div class="hero-body">
      <div class="container">
        ...
        <h2 class="subtitle has-text-white shadow">Amelanderkaap</h2>
      </div>
    </div>
  </section>
      ...
      <div class="columns">
        <div class="column is-half">
          <form id="send">
            ...
            <div class="field">
              <div class="control">
                <input id="send_email" class="input" type="email" placeholder="Email adres" required>
              </div>
            </div>
            <div class="field">
              <div class="control">
                <input id="send_phone" class="input" type="tel" placeholder="Telefoon nummer" required>
              </div>
            </div>
            <div class="field">
              <div class="control">
